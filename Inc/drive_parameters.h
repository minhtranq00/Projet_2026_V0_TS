...
#define SW_DEADTIME_NS                      110 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KP_DEFAULT               2495
#define PID_TORQUE_KI_DEFAULT               1248
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2495
#define PID_FLUX_KI_DEFAULT                 1248
...
#define PID_SPEED_KP_DEFAULT                2388/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define FINAL_I_ALIGNMENT_A                 18.9 /*!< s16A */
