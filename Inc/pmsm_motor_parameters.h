...
#define LS                      0.001 /* Stator inductance, H
...
#define MOTOR_VOLTAGE_CONSTANT  66.6 /*!< Volts RMS ph-ph /kRPM */
#define MOTOR_MAX_SPEED_RPM     5000 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       18.9

#define ID_DEMAG_A              -18.9 /*!< Demagnetization current */
