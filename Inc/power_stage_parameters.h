...
#define HW_DEAD_TIME_NS                      120 /*!< Dead-time inserted
                                                      by HW if low side signals
                                                      are not used */
/*********** Bus voltage sensing section ****************/
#define VBUS_PARTITIONING_FACTOR             0.00808865162177465 /*!< It expresses how
...
#define V0_V                                 3.121 /*!< in Volts */
#define T0_C                                 25 /*!< in Celsius degrees */
#define dV_dT                                -0.002 /*!< V/Celsius degrees */
